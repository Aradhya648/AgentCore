...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(
        name='billing.background_skip_turn_auth_dead',
        description='本回合 API Key 鉴权已死后跳过后台 chrome（非进程 TTL 熔断）',
    ),
    ...
    EventSpec(
        name='llm.turn_auth_dead',
        description='本回合首次确认真 API Key 鉴权死（不含推理令牌过期）',
        fields={
            'credential_source': FieldType('str'),
        },
    ),
    ...
    EventSpec(name='recover.lease_stalled'),
    EventSpec(name='recover.lease_timeout'),
