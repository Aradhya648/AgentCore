...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(name='ask_user.automation_delivery_rejected'),
    EventSpec(name='ask_user.card_rejected'),
    EventSpec(name='ask_user.kickoff_proposal_rejected'),
    EventSpec(name='ask_user.list_arg_rejected'),
    EventSpec(name='ask_user.nonblocking'),
    EventSpec(name='ask_user.presentation_format_rejected'),
    EventSpec(name='ask_user.website_style_rejected'),
    ...
    EventSpec(name='automation.delivery_confirmed'),
    EventSpec(name='automation.delivery_not_confirmed'),
    ...
    EventSpec(name='chat.retry_failed_error'),
    ...
    EventSpec(
        ...
        description='回合收尾（含 Phase-0 延迟：prepare/assemble/ttft_*）',
        fields={
    ...
    EventSpec(name='compaction.done'),
    EventSpec(name='compaction.failed'),
    EventSpec(name='compaction.timeout'),
    ...
    EventSpec(name='debate.pretrial.investigators_build_failed'),
    EventSpec(name='debate.pretrial.investigators_done'),
    EventSpec(name='debate.pretrial.order_llm_failed'),
    EventSpec(name='debate.pretrial.persist_notes_failed'),
    EventSpec(name='debate.pretrial.refresh_dossier_failed'),
    ...
    EventSpec(name='delegate.automation_delivery_full_auto_default'),
    EventSpec(name='delegate.automation_delivery_rejected'),
    ...
    EventSpec(name='delegate.presentation_format_full_auto_default'),
    EventSpec(name='delegate.presentation_format_rejected'),
    EventSpec(name='delegate.presentation_format_soft_tip'),
    EventSpec(name='delegate.rejected'),
    EventSpec(name='delegate.resume_plan'),
    EventSpec(name='delegate.retry_seed_remap'),
    EventSpec(name='delegate.retry_seed_replayed'),
    ...
    EventSpec(name='delegate.website_style_full_auto_default'),
    EventSpec(name='delegate.website_style_rejected'),
    EventSpec(
    ...
    EventSpec(name='engine.zero_write_warn'),
    ...
    EventSpec(name='file_write.length_nudge'),
    EventSpec(name='file_write.non_empty_code_overwrite_rejected'),
    EventSpec(name='file_write.substantial_overwrite_rejected'),
    ...
    EventSpec(name='llm.stream_stalled'),
    ...
    EventSpec(name='memory.explore_workspace_key_written'),
    ...
    EventSpec(name='presentation.format_confirmed'),
    EventSpec(name='presentation.format_not_confirmed'),
    ...
    EventSpec(name='website.style_confirmed'),
    EventSpec(name='website.style_not_confirmed'),
