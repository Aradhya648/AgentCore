...
_ASSESS_SYSTEM = (
    ...
    "【来源等级】挂钩——优先读 user 里【本轮引用证据台账】给出的 tier"
    "（official=司法文书/官方原文 > media=权威媒体 > weak=自媒体/百科/转述；"
    "unknown=来源待评、【不是】弱源实锤），勿臆造等级；无台账块时仍按同阶梯从出处猜。"
    "（高等级可给满；决定性事实仅挂权威媒体且无交叉印证=中等封顶；仅自媒体/百科/转述=弱、"
    "evidence 封顶打低）。【已核实】若挂在弱源（自媒体/百科/转述 / tier=weak）上，必须在 note 或"
    "penalties 中点名该弱源；逻辑谬误（如循环论证）与【把待核实 / 无据主张硬拗成既定事实】必须扣分"
