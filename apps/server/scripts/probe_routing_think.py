...
从 apps/server 跑::
    ...
    uv run python scripts/probe_routing_think.py
    uv run python scripts/probe_routing_think.py --samples 2
    uv run python scripts/probe_routing_think.py --keys vague_website,design_to_api --quiet
