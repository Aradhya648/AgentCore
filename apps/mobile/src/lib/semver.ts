/**
 * Semver helpers for Android sideload soft-update (compare local build vs
 * GitHub `AgentCore-*-android.apk` release).
 */
...
/**
 * Whether the local native build should show the soft update banner.
 * `clientVersion()==="dev"` and empty remote never trigger.
 */
